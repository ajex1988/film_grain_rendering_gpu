...
*/
int film_grain_rendering_gpu(const char* fIn, const char* fOut, float grainSize, int nIter) {
    /**************************************************/
    /*************   Marshaling   ***************/
    /**************************************************/
    std::string fileNameIn = fIn;
    std::string fileNameOut = fOut;
